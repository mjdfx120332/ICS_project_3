...
# ==============================================================================                               
                ...
                # IMPLEMENTATION
                # ---- start your code ---- #
                msg_from_peer = msg["message"]
                i = self.indices[from_name]
                i.add_msg_and_index(msg_from_peer)
                pass
                # ---- end of your code --- #
                ...
                for g in the_guys:
                    ...
                    # ---- start your code ---- #
                    i_1 = self.indices[g]
                    i_1.add_msg_and_index(msg_from_peer)
                    mysend(to_sock,json.dumps({"action": "exchange", "from": from_name, \
                                              "message": msg_from_peer}))
...
# ==============================================================================
                ...
                # ---- start your code ---- #
                from_name = self.logged_sock2name[from_sock]
                sonnet_number = int(msg["target"])
                print(from_name, "asks for", sonnet_number)
                poem_lst = self.sonnet.get_poem(sonnet_number)
                poem = "\n".join(poem_lst)
...
# ==============================================================================
                ...
                search_rslt = ""
                for k in self.indices[from_name].search(search_target):
                    search_rslt += str(k)
